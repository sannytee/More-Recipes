...
export default (app) => {
  ...
  app.post('/api/v1/recipes/:recipeId/upvotes', authentication.verifyUser, voteController.upvote);
  app.post('/api/v1/recipes/:recipeId/downvotes', authentication.verifyUser, voteController.downvote);
};
