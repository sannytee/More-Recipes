...
import { checkBeforeCreatingRecipe } from '../middlewares/validation';
...
export default (app) => {
  ...
  app.post('/api/v1/recipes', authentication.verifyUser, checkBeforeCreatingRecipe, recipeController.addRecipe);
